...
Плагин для Minecraft серверов на Paper 1.21.8, предоставляющий удобную обертку для работы с голограммами через DecentHolograms с системой лимитов и управлением правами доступа.
